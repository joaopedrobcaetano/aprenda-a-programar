// Não consegui fazer este exercício, olhei a solução.
...
let valorTotalVendasSemGorjeta = 0
let i = 0

while (i < receita.length) {
    valorTotalVendasSemGorjeta += receita[i].valor
    i++
}

console.log("Valor total de vendas sem gorjeta: ", valorTotalVendasSemGorjeta)
/* ----------------------------------------------------------------------------- */
...
console.log("Valor total de vendas com gorjeta: ", valorTotalVendasComGorjeta)
/* ----------------------------------------------------------------------------- */
